...
{
	header("Location:".SITE_URL."/FirmaUser/login");
}
?>
...
-->         
			...
			<li class="treeview active">
              <a href="#">
                <i class="fa fa-plus-square"></i> <span>Stok Yönetimi</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
			...
			<li>
              <a href="<?php echo SITE_URL; ?>/user/cikis">
