...
<html>
  <head>
    ...
    <title>firma Kullanıcı Kayıt Formu</title>
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="javascript:void()"><b>Firma Kullanıcı Kayıt Formu</b></a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        ...
        <form action="<?php echo SITE_URL; ?>/updateUser/update" method="post">
          ...
          <div class="form-group has-feedback">
            <input type="text" class="form-control" name="firmaUyeAd" placeholder="Firma Ad">
            <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
          </div>
		  <div class="form-group has-feedback">
            <input type="text" class="form-control" name="firmaAdres" placeholder="Firma Adresi">
            <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
          </div>
		  <div class="form-group has-feedback">
          ...
          <div class="form-group has-feedback">
            <input type="password" name="firmaSifre" class="form-control" placeholder="Firma Şifre" style="width:100%;">
            <span class="glyphicon glyphicon-lock form-control-feedback"></span>
          </div>
          <div class="row">
           
            <div class="col-xs-4">
              <button type="submit" class="btn btn-primary btn-block btn-flat">Kayıt</button>
            </div><!-- /.col -->
